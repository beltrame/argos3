/**
 * @file <argos3/plugins/robots/bunker/simulator/bunker_entity.h>
 *
 * @author Giovanni Beltrame - <giovanni.beltrame@polymtl.ca>
 */

#ifndef BUNKER_ENTITY_H
#define BUNKER_ENTITY_H
...
namespace argos {
   ...
   class CBunkerEntity : public CComposableEntity {
   ...
   public:
      ...
      CBunkerEntity(const std::string& str_id,
