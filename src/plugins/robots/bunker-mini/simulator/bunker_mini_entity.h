/**
 * @file <argos3/plugins/robots/bunker-mini/simulator/bunker_mini_entity.h>
 *
 * @author Giovanni Beltrame - <giovanni.beltrame@polymtl.ca>
 */

#ifndef BUNKER_MINI_ENTITY_H
#define BUNKER_MINI_ENTITY_H
...
namespace argos {
   ...
   class CBunkerMiniEntity : public CComposableEntity {
   ...
   public:
      ...
      CBunkerMiniEntity(const std::string& str_id,
